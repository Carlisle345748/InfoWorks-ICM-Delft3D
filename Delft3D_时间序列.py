...
import sys
# reference_time = pd.to_datetime('2020-03-31 00:00:00')
...
yj_down.plot2('1')  # 检查数据有效性
yj_down.plot2('10')  # 检查数据有效性
# 由于1号数据不全，所以两端都用10号的数据
down_transport_A = yj_down.completed_time_interpolate(down_dataset['10']['cond'], start, end, "10Min")
down_transport_B = yj_down.completed_time_interpolate(down_dataset['10']['cond'], start, end, "10Min")
